...
class SSHController extends Controller
{
    ...
    public function connectAndUpdate(Request $request)
    {
      ...
      $randomPassword = Str::random(10);
        ...
        $activationLinkDisplay = null;
        if ($customer->request_type === 'subscribe') {
            // If subscribing, setup for subscription and send subscription info mail
            ...
            // For other request types, just activate and send the activation link
