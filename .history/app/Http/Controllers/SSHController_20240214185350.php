...
class SSHController extends Controller
{
    ...
    private function setupFrontDirectory($path, $customLink)
    {
        ...
        $this->ssh->exec(
            'echo ' . escapeshellarg($jsonContent) . " > $configJsonPath"
        );
    }
    ...
    private function setupBackDirectory(
        ...
        $dbName = "client_db_$newClientNumber"; // Prefixing for better DB name management
        $envPath = "$path/.env";
    ...
    private function uploadFilesToRemoteDirectory(
        $localDirectory,
        $remoteDirectory
    ) {
