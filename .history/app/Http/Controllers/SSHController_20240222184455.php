...
class SSHController extends Controller
{
    ...
    private function setupForSubscribe($newClientNumber, $customerEmail, $firstName, $randomPassword)
    {
        ...
        $insertUserCommand = "PGPASSWORD='{$this->pgsqlPassword}' psql -U {$this->pgsqlUsername} -h 127.0.0.1 -p {$this->pgsqlPort} -d \"$dbName\" -c \"INSERT INTO users (email, password, name, id_role) VALUES ('$customerEmail', '$hashedPassword', '$escapedFirstName', '27');\"";
