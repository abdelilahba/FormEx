...
public function update(Request $request, $id)
    ...
    {
        // Preload the payment methods relationship
        $customer = Customer::with('PaymentMethods')->find($id);
        if ($customer) {
            // Pass the customer data, including payment methods, to the view
            return view('details.detailsCustomer', compact('customer'));
        } else {
            abort(404); // Handle the "not found" case
        }
    }
