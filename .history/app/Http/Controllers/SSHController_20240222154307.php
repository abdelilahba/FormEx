...
class SSHController extends Controller
{
    ...
    {
        // Example: Truncate all tables or delete data while keeping the schema
        // This method should be tailored to your application's specific requirements
        // Example SQL command to truncate a specific table (adjust as needed):
        $truncateCommand = "PGPASSWORD='{$this->pgsqlPassword}' psql -U {$this->pgsqlUsername} -h 127.0.0.1 -p {$this->pgsqlPort} -d \"$dbName\" -c \"TRUNCATE TABLE users RESTART IDENTITY;\"";
        $this->ssh->exec($truncateCommand);
    
        // Repeat the truncate or delete command for other tables as needed
    }
