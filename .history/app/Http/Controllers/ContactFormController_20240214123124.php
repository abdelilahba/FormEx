    ...
    public function store(Request $request)
{
        ...
        return response()->json([
            'success' => true,
            'message' => 'Registration successful, please check your email to complete the registration.',
...
public function activate(Request $request)
{
    ...
    if ($customer) {
        ...
        $activationLinkDisplay = "http://" . strtolower($companyShort) . $randomNumber . strtolower($randomChar) . ".khabirak.pro";
       ...
       // $this->sendActivationEmail($customer, $activationLink);
        ...
        return response()->json(['success' => true, 'message' => 'Customer activated successfully!', 'activationLink' => $activationLinkDisplay]);
    }
...
public function deactivate(Request $request)
{
    ...
    if ($customer) {
       ...
       // $this->sendActivationEmail($customer, $activationLink);
        ...
        return response()->json(['success' => true, 'message' => 'Customer desactivated successfully!']);
    }
