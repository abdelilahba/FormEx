...
class ProfileCompletionController extends Controller
{
    ...
    protected function handleProfileUpdate(array $data, $files, Customer $customer)
    {
    ...
    public function subscribe($random){
        ...
        $data = [
            'address_line1' => $queryParams['address_line1'],
            'address_line2' => $queryParams['address_line2'],
            'city' => $queryParams['city'],
            'postal_code' => $queryParams['postal_code'],
