...
class LocaleMiddleware
{
 /**
    ...
    {
        $authRoutes = ['login', 'register', 'forgot-password', 'reset-password', 'logout','dashboard', "listcus", "activate-customer","deactivate-customer","profile.complete","listpayement","listinvoice","submit-form","detailscutomer"];
