...
Route::get('/complete-profile/{id}', [ProfileCompletionController::class, 'showCompleteProfileForm'])->name('profile.complete-form');
...
Route::middleware(['auth:sanctum', 'verified', 'isAdmin'])->group(function () {
    ...
    Route::get('/details/{id}',[CustomerController::class, 'getCustomerId']);
