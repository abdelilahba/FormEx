...
Route::group(['prefix' => '{locale}', 'where' => ['locale' => '(ar|fr)']], function () {
    ...
    Route::get('/subscription/{random_number}', function ($random) {
        // Attempt to retrieve the customer based on the random number
        $customer = Customer::where('random_number', $random)->firstOrFail();
    
        // Capture all query parameters from the request
        $queryParams = request()->all();
    
        // Pass the customer information and query parameters to the view
