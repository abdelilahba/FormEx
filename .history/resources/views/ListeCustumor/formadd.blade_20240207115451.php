                ...
                <div class="modal-body py-10 px-lg-17" bis_skin_checked="1">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px" style="max-height: 182px;background-color: white;" bis_skin_checked="1">
                        ...
                        <div class="fv-row mb-7 fv-plugins-icon-container" bis_skin_checked="1">
                            ...
                            <!--begin::Input-->
                            <input type="text"  class="form-control form-control-solid" placeholder="" name="company_name" required >
                            <!--end::Input-->
                        ...
                        <div class="fv-row mb-7 fv-plugins-icon-container" bis_skin_checked="1">
                            ...
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid" name="last_name" placeholder=""   >
                            <!--end::Input-->
                        ...
                        <!--end::Input group-->
                         ...
                         <div class="fv-row mb-7" bis_skin_checked="1">
                            ...
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid" placeholder="" name="position">
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <div class="fv-row mb-7" bis_skin_checked="1">
                            ...
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid" placeholder=""  name="phone_number">
                            <!--end::Input-->
                        </div>
                        ...
                        <div id="kt_modal_add_customer_billing_info" class="collapse show" bis_skin_checked="1">
                            ...
                            <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container" bis_skin_checked="1">
                                ...
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" placeholder="" name="address_line1" value="101, Collins Street">
                                <!--end::Input-->
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback" bis_skin_checked="1"></div></div>
                            <!--end::Input group-->
                            ...
                            <div class="d-flex flex-column mb-7 fv-row" bis_skin_checked="1">
                                ...
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" placeholder="" name="address_line2" value="">
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="row g-9 mb-7" bis_skin_checked="1">
                                ...
                                <div class="col-md-12 fv-row fv-plugins-icon-container" bis_skin_checked="1">
                                    ...
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="" name="post_code" value="3000">
                                    <!--end::Input-->
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback" bis_skin_checked="1"></div></div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container" bis_skin_checked="1">
                                ...
                                <!--begin::Input-->
                                <select  name="specialization" aria-label="Select a Country" data-control="select2" data-placeholder="Select a Country..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bold select2-hidden-accessible"  tabindex="-1" aria-hidden="true" data-kt-initialized="1" >
