...
<form class="form fv-plugins-bootstrap5 fv-plugins-framework" id="customerForm" method="POST" action="{{ route('profile.complete', ['locale' => app()->getLocale()]) }}">
      ...
      <div class="form-group form-check" style="color: black;margin-top: 15px;">
         <input type="checkbox" class="form-check-input" id="agreement" name="agreement" required>
         <label class="form-check-label" style="color: black;margin-top: 5px;" for="agreement">{{ __('messages.accept') }} <a href="/terms">{{ __('messages.terms_agreement') }}</a>.</label>
      </div>
