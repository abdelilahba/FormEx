...
<form method="POST" class="d-inline" id="language-switch-form">
    @csrf
...
$(document).ready(function() {
    ...
    form.on('submit', function (e) {
        ...
        console.log(locale);
        const actionUrl = locale ? `/${locale}/submit-form` : '/submit-form';
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success) {
                    ...
                    const detailsUrl = `/complete-profile/${data.random_number}`; // Adjusted to use random_number
...
function getCurrentLocale() {
    ...
    console.log(path);
    // Assuming your locale codes are 2 characters long (e.g., "ar", "fr")
    const localeMatch = path.match(/^\/(\w\w)\//);
    console.log(localeMatch);
    return localeMatch ? localeMatch[0] : null; // Returns the locale or null if not found
}
</script>
