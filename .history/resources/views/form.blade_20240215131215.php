<div class="col-md-5 form-section">
   <form class="form fv-plugins-bootstrap5 fv-plugins-framework" id="customerForm"  method="POST"   >
    ...
    <!-- Ensure the checkbox is always first -->
    <input type="checkbox" class="form-check-input" id="agreement" name="agreement" required>
    
    <!-- The label follows the checkbox -->
    <label class="form-check-label" for="agreement">{{ __('messages.accept') }} <a href="{{ route('terms', app()->getLocale()) }}">{{ __('messages.terms_agreement') }}</a>.</label>
</div>
