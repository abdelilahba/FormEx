...
$('#kt_docs_select2_country').select2({
    templateSelection: optionFormat(null , "kt_docs_select2_country" ),
    templateResult: optionFormat(null , "kt_docs_select2_country" ),
});
$('#kt_docs_select3_country').select2({
    templateSelection: optionFormat(null , "kt_docs_select3_country" ),
    templateResult: optionFormat(null , "kt_docs_select3_country" ),
});
</script>
