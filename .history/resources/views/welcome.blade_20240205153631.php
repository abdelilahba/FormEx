...
@php
    $highlightedText = "<span class=\"highlight\">Votre Expert</span>";
    if (app()->getLocale() === 'ar') {
        $highlightedText = "<span class=\"highlight\">خبيرك</span>";
    }
@endphp
<div class="container mt-5">
    <div class="row equal-height">
      ...
      <div class="col-md-7 description-section">
        ...
        {!! str_replace(':highlighted_text', $highlightedText, __('messages.descriptionp3')) !!}
