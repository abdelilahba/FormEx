...
<style>
        body, .specific-section { /* Replace .specific-section with the actual class if targeting a specific section */
            background: url("{{ asset('logo/expertlogo.png') }}") no-repeat center center fixed !important;         
