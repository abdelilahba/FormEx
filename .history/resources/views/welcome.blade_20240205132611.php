...
<form action="{{ route('language.change') }}" method="POST" class="d-inline">
            ...
            <select name="language" class="form-select form-control" onchange="this.form.submit()"   id="kt_docs_select2_country">
               <option value="fr" {{ App::getLocale() == 'fr' ? ' selected' : '' }} data-kt-select2-country="assets/media/flags/france.svg">Français</option>
               <option value="ar" {{ App::getLocale() == 'ar' ? ' selected' : '' }}  data-kt-select2-country="assets/media/flags/morocco.svg">العربية</option>
            </select>
