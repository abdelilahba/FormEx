                    ...
                    <div class="d-flex flex-wrap py-5" bis_skin_checked="1">
                            ...
                            <div class="flex-equal " bis_skin_checked="1">
                                <table class="table table-flush fw-semibold gy-1">
                                        ...
                                        <td class="text-gray-800">{{ $customer->address_line1 }}    </td>
                                    </tr>
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Phone</td>
                                        <td class="text-gray-800">{{ $customer->phone_number }}</td>
                                    </tr>
                                                                    <tr>
                                        <td class="text-muted min-w-125px w-125px">Email</td>
                                        <td class="text-gray-800"><a href="#" class="text-gray-900 text-hover-primary">{{ $customer->email }} </a></td>
                                    </tr>
                                                                    <tr>
