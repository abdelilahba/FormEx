                    ...
                    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" id="customerForm" method="POST" action="{{ route('profile.complete', ['locale' => app()->getLocale()]) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-10">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" data-placeholder="{{ __('messages.company_size') }}">
                                    <option></option>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="stinaf" name="stinaf" data-placeholder="{{ __('messages.company_size') }}">
                                    <option></option>
