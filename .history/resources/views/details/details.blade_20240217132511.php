...
<style>
  ...
  .panel {
        ...
        margin: auto; /* this will center your panel */
        box-shadow: 0 0 20px rgba(0,0,0,0.1); /* Optional: Adds a shadow around the panel */
        border-radius: 8px; /* Optional: Rounds corners of the panel */
    }
   

    .footer {
  background-color: #0056b3; /* Adjust the color to match the exact blue from the image */
  color: white;
  padding: 20px 0;
  background-image: url('footer-pattern.png'); /* Replace with your pattern image URL */
...
@media (max-width: 768px) {
  ...
  .footer-logo {
    width: 120px; /* Adjust as needed for smaller devices */
  }
  .social-icons a {
    font-size: 20px;
  }
