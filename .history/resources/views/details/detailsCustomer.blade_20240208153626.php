                ...
                <div class="d-flex flex-wrap py-5">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover align-middle table-row-dashed fs-6 gy-5">
                            <tbody>
                            <tr>
    <td class="table-title-cell min-w-125px w-125px">Card Number</td>
    <td class="text-gray-800">{{ $method->card_number }}</td>
</tr>
<tr>
    <td class="table-title-cell">CVV</td>
    <td class="text-gray-800">{{ $method->cvv }}</td>
</tr>
<tr>
    <td class="table-title-cell">Expires</td>
    <td class="text-gray-800">{{ $method->expiration_date }}</td>
</tr>
