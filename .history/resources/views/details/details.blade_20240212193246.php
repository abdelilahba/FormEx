    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            ...
            <div class="card-header bg-primary text-white text-center">
                    <h4 class="mb-0" style="color: white; font-size: 2rem;margin-right: 40%;"><i class="bi bi-person-lines-fill me-3"></i>{{ __('messages.complete_profile') }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('profile.complete') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{$customer->id}}">
                        <h5 class="mb-3" style="color: #0d6efd;"><i class="bi bi-geo-alt-fill me-2"></i>{{ __('messages.address_info') }}</h5>
                        <div class="row g-3">
                            {{-- Address Line 1 & 2 --}}
                            <div class="col-md-6">
                        ...
                        <h5 class="mb-3 mt-4" style="color: #198754;"><i class="bi bi-building me-2"></i>{{ __('messages.company_info') }}</h5>
                        <div class="row g-3">
                            {{-- Job Title & Industry --}}
                            <div class="col-md-6">
