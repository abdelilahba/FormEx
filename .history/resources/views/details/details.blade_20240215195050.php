                ...
                <div class="card-body">
                    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" id="customerForm" method="POST" action="{{ route('profile.complete', ['locale' => app()->getLocale()]) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-10">
                            ...
                            <div class="col-md-4">
                                <label for="industry" class="form-label">stinaf</label>
                                <select class="form-select"  data-control="select2"  data-placeholder="{{ __('messages.company_size') }}">
                                    <option></option>
                            ...
                            <div class="col-md-4">
                                <label for="industry" class="form-label">ibtida2iya</label>
                                <select class="form-select"  data-control="select2" id="stinaf" name="stinaf" data-placeholder="{{ __('messages.company_size') }}">
                                    <option></option>
