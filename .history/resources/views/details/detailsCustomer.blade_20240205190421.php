        ...
        <div id="kt_customer_view_details" class="collapse show" bis_skin_checked="1">
            <div class="py-5 fs-6" bis_skin_checked="1">
                ...
                <!--begin::Badge-->
                    ...
                    <div class="text-gray-600" bis_skin_checked="1"><a href="#" class="text-gray-600 text-hover-primary">info@keenthemes.com</a></div>
                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                    <div class="fw-bold mt-5" bis_skin_checked="1">Billing Address</div>
                    <div class="text-gray-600" bis_skin_checked="1">101 Collin Street, <br>Melbourne 3000 VIC<br>Australia</div>
                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                    <div class="fw-bold mt-5" bis_skin_checked="1">Language</div>
                    <div class="text-gray-600" bis_skin_checked="1">English</div>
                    <!--begin::Details item-->
                                    <!--begin::Details item-->
