                    ...
                    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" id="customerForm" method="POST" action="{{ route('profile.complete', ['locale' => app()->getLocale()]) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="d-flex justify-content-around mt-4">
                                ...
                                <a href="{{ route('demo.request', ['locale' => app()->getLocale()]) }}" class="btn btn-secondary">{{ __('messages.request_demo') }}</a>

                                <!-- Subscription button -->
                                <a href="{{ route('subscription', ['locale' => app()->getLocale()]) }}" class="btn btn-success">{{ __('messages.subscribe') }}</a>
                            </div>
                    </form>
                </div>
            </div>
