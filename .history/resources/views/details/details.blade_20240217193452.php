                    ...
                    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" id="customerForm" method="POST" action="{{ route('profile.complete', ['locale' => app()->getLocale()]) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="d-flex justify-content-around mt-4">
                                ...
                                <button id="request_demo" data-href="/subscription/{{ $customer->random_number }}">Request Demo</button>
...
<script>
    $('#request_demo').on("click", function(e) {
        const demoUrl = $(this).data('href');
        const locale = window.location.pathname.split('/')[1];
        console.log(locale);

        const combinet= `${locale}${demoUrl}`
        console.log(combinet);
        //window.location.href = combinet;
    });
