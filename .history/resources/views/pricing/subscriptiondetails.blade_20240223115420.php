        ...
        <div class="d-flex flex-column flex-lg-row" bis_skin_checked="1">
            ...
            <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0" bis_skin_checked="1">
                ...
                <form class="form" action="#" id="kt_subscriptions_create_new">
                    ...
                    <div class="card card-flush pt-3 mb-5 mb-lg-10" bis_skin_checked="1">
                        <!--begin::Card header-->
                        <div class="card-header" style="display: block;text-align: center;" bis_skin_checked="1">
                            <!--begin::Card title-->
                    ...
                    <div class="card card-flush pt-3 mb-5 mb-lg-10" data-kt-subscriptions-form="pricing" bis_skin_checked="1">
                        ...
                        <div class="card-header" style="display: block;" bis_skin_checked="1">
                            <!--begin::Card title-->
                            <div class="card-title" style="display: block;text-align: center;" bis_skin_checked="1">
                    ...
                    <form class="form" id="kt_subscriptions_create_new">
                        <input type="hidden" name="random_number" value="{{ $customer->random_number }}">
                        <input type="hidden" name="locale" value="{{ app()->getLocale() }}">
                        <!-- Your other form fields -->
                        <button class="btn btn-success text-white" type="button" id="pay_now">{{ __('messages.pay_now') }}</button>
                    </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        payNowBtn.addEventListener('click', function(e) {
           ...
           // const formData = new FormData(document.getElementById('kt_subscriptions_create_new'));
            const form = document.getElementById('kt_subscriptions_create_new'); // Reference to your form
            ...
            fetch(`${locale}/subscribe`, {
                    method: 'POST',
                    body: formData, // Use FormData directly if not using JSON
                    headers: {
                        'X-Requested-With': 'XMLHttpRequest',
                        'X-CSRF-TOKEN': '{{ csrf_token() }}' // Include CSRF token for web routes
                    },
                })
