                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 fw-semibold gy-4 dataTable no-footer" id="kt_subscription_products_table">
                                            <thead>
                                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="min-w-100px sorting_disabled" rowspan="1" colspan="1" style="width: 130.328px;">Storage</th>
                                                    <th class="min-w-100px sorting_disabled" rowspan="1" colspan="1" style="width: 130.328px;">Users Included</th>
                                                    <th class="min-w-150px sorting_disabled" rowspan="1" colspan="1" style="width: 193.016px;">Price</th>
                                                </tr>
                                            </thead>
