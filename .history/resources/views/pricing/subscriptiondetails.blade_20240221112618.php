                        ...
                        <div class="card-body pt-0" bis_skin_checked="1">
                            ...
                            <div class="table-responsive" bis_skin_checked="1">
                                ...
                                <div id="kt_subscription_products_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer" bis_skin_checked="1" >
                                    <div class="table-responsive" bis_skin_checked="1">
                                        <table class="table table-bordered table-hover align-middle table-row-dashed fs-6 gy-5" id="kt_subscription_products_table">
                                            <thead>
                                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0" style="direction: ltr;">
                                                    <th >Product</th>
                                                    <th >Storage</th>
