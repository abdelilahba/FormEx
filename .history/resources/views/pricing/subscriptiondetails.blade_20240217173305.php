                    ...
                    <div class="card card-flush pt-3 mb-5 mb-lg-10" bis_skin_checked="1">
                        ...
                        <div class="card-body pt-0" bis_skin_checked="1">
                            ...
                            <div class="d-flex flex-column mb-15 fv-row" bis_skin_checked="1">
                                ...
                                <div class="table-responsive" bis_skin_checked="1">
                                    <!--begin::Table-->
                                    <div id="kt_create_new_custom_fields_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer" bis_skin_checked="1">
                                        <div class="table-responsive" bis_skin_checked="1">
                                            <table id="kt_create_new_custom_fields" class="table align-middle table-row-dashed fw-semibold fs-6 gy-5 dataTable no-footer">
                                                <!--begin::Table head-->
                                                <thead>
                                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        <th class="pt-0 sorting_disabled" rowspan="1" colspan="1" style="width: 359.016px;">Field Name</th>
                                                        <th class="pt-0 sorting_disabled" rowspan="1" colspan="1" style="width: 364.641px;">Field Value</th>
                                                        <th class="pt-0 text-end sorting_disabled" rowspan="1" colspan="1" style="width: 88.0938px;">Remove</th>
                                                    </tr>
                                                </thead>
                                                <!--end::Table head-->
