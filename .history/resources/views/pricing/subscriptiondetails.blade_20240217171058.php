...
<div class="card card-flush pt-3 mb-5 mb-lg-10" bis_skin_checked="1">
    ...
    <div class="card-body pt-0" bis_skin_checked="1">
        <!--begin::Description-->
        <div class="text-gray-500 fw-semibold fs-5 mb-5" bis_skin_checked="1">
        ...
        <div class="mb-7 d-none" bis_skin_checked="1">
            ...
            <a href="/metronic8/demo1/apps/customers/list.html" class="btn btn-light-primary">Add New Customer</a>
        </div>
...
<!--begin::Notice-->
<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed rounded-3 p-6" bis_skin_checked="1">
    ...
    <div class="d-flex flex-stack flex-grow-1 " bis_skin_checked="1">
            ...
            <div class=" fw-semibold" bis_skin_checked="1">
                                    ...
                                    <div class="fs-6 text-gray-700 " bis_skin_checked="1">Writing headlines for blog posts is much science and probably cool audience. <a href="#" class="fw-bold">Learn more</a>.</div>
                            </div>
            <!--end::Content-->
...
<div class="card card-flush pt-3 mb-5 mb-lg-10" bis_skin_checked="1">
    ...
    <div class="card-body pt-0" bis_skin_checked="1">
        ...
        <div class="table-responsive" bis_skin_checked="1">
            <!--begin::Table-->
            <div id="kt_subscription_products_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer" bis_skin_checked="1"><div class="table-responsive" bis_skin_checked="1"><table class="table align-middle table-row-dashed fs-6 fw-semibold gy-4 dataTable no-footer" id="kt_subscription_products_table">
                <thead>
                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0"><th class="min-w-300px sorting_disabled" rowspan="1" colspan="1" style="width: 378.625px;">Product</th><th class="min-w-100px sorting_disabled" rowspan="1" colspan="1" style="width: 130.328px;">Qty</th><th class="min-w-150px sorting_disabled" rowspan="1" colspan="1" style="width: 193.016px;">Total</th><th class="min-w-70px text-end sorting_disabled" rowspan="1" colspan="1" style="width: 90.2812px;">Remove</th></tr>
                </thead>
            ...
            </table></div><div class="row" bis_skin_checked="1"><div class="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start" bis_skin_checked="1"></div><div class="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end" bis_skin_checked="1"></div></div></div>
            <!--end::Table-->
        </div>
        <!--end::Table wrapper-->
    </div>
    ...
    <div class="card-body pt-0" bis_skin_checked="1">
        ...
        <div id="kt_create_new_payment_method" bis_skin_checked="1">
                    ...
                    <div class="py-3 d-flex flex-stack flex-wrap" bis_skin_checked="1">
                        ...
                        <div class="d-flex align-items-center collapsible toggle " data-bs-toggle="collapse" data-bs-target="#kt_create_new_payment_method_1" bis_skin_checked="1">
                            ...
                            <div class="btn btn-sm btn-icon btn-active-color-primary ms-n3 me-2" bis_skin_checked="1">
                                ...
                                <i class="ki-duotone ki-plus-square toggle-off fs-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>                            </div>
                            <!--end::Arrow-->
                            ...
                            <div class="me-3" bis_skin_checked="1">
                                <div class="d-flex align-items-center fw-bold" bis_skin_checked="1">Mastercard                                                                            <div class="badge badge-light-primary ms-5" bis_skin_checked="1">Primary</div>
                                                                    </div>
                        ...
                        <div class="d-flex flex-wrap py-5" bis_skin_checked="1">
                                ...
                                <div class="flex-equal me-5" bis_skin_checked="1">
                                    <table class="table table-flush fw-semibold gy-1">
                                            ...
                                            <td class="text-gray-800">**** 6083</td>
                                        </tr>
                                                                            <tr>
                                ...
                                <div class="flex-equal " bis_skin_checked="1">
                                    <table class="table table-flush fw-semibold gy-1">
                                            ...
                                            <td class="text-gray-800">Australia <div class="symbol symbol-20px symbol-circle ms-2" bis_skin_checked="1"><img src="/metronic8/demo1/assets/media/flags/australia.svg"></div></td>
                                        </tr>
                                                                            <tr>
                ...
                <div class="py-1" bis_skin_checked="1">
                    ...
                    <div class="py-3 d-flex flex-stack flex-wrap" bis_skin_checked="1">
                        <!--begin::Toggle-->
                        <div class="d-flex align-items-center collapsible toggle collapsed" data-bs-toggle="collapse" data-bs-target="#kt_create_new_payment_method_2" bis_skin_checked="1">
                            <!--begin::Arrow-->
                            <div class="btn btn-sm btn-icon btn-active-color-primary ms-n3 me-2" bis_skin_checked="1">
                                <i class="ki-duotone ki-minus-square toggle-on text-primary fs-2"><span class="path1"></span><span class="path2"></span></i>
                                <i class="ki-duotone ki-plus-square toggle-off fs-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>                            </div>
                            ...
                            <!--begin::Summary-->
                            <div class="me-3" bis_skin_checked="1">
                                <div class="d-flex align-items-center fw-bold" bis_skin_checked="1">Visa                                                                    </div>
                    ...
                    <!--begin::Body-->
                    <div id="kt_create_new_payment_method_2" class="collapse  fs-6 ps-10" bis_skin_checked="1">
                        <!--begin::Details-->
                        <div class="d-flex flex-wrap py-5" bis_skin_checked="1">
                                                            <!--begin::Col-->
                                <div class="flex-equal me-5" bis_skin_checked="1">
                                    <table class="table table-flush fw-semibold gy-1">
                                            ...
                                            <td class="text-gray-800">Melody Macy</td>
                                                                            ...
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                            <td class="text-gray-800">**** 8202</td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">Expires</td>
                                ...
                                <div class="flex-equal " bis_skin_checked="1">
                                    <table class="table table-flush fw-semibold gy-1">
                                            ...
                                            <td class="text-gray-800"><a href="#" class="text-gray-900 text-hover-primary">melody@altbox.com</a></td>
                                                                            ...
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">Origin</td>
                                            <td class="text-gray-800">United Kingdom <div class="symbol symbol-20px symbol-circle ms-2" bis_skin_checked="1"><img src="/metronic8/demo1/assets/media/flags/united-kingdom.svg"></div></td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">CVC check</td>
                ...
                <div class="py-1" bis_skin_checked="1">
                    ...
                    <div class="py-3 d-flex flex-stack flex-wrap" bis_skin_checked="1">
                        <!--begin::Toggle-->
                        <div class="d-flex align-items-center collapsible toggle collapsed" data-bs-toggle="collapse" data-bs-target="#kt_create_new_payment_method_3" bis_skin_checked="1">
                            <!--begin::Arrow-->
                            <div class="btn btn-sm btn-icon btn-active-color-primary ms-n3 me-2" bis_skin_checked="1">
                                <i class="ki-duotone ki-minus-square toggle-on text-primary fs-2"><span class="path1"></span><span class="path2"></span></i>
                                <i class="ki-duotone ki-plus-square toggle-off fs-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>                            </div>
                            ...
                            <!--begin::Summary-->
                            <div class="me-3" bis_skin_checked="1">
                                <div class="d-flex align-items-center fw-bold" bis_skin_checked="1">American Express                                                                            <div class="badge badge-light-danger ms-5" bis_skin_checked="1">Expired</div>
                                                                    </div>
                    ...
                    <!--begin::Body-->
                    <div id="kt_create_new_payment_method_3" class="collapse  fs-6 ps-10" bis_skin_checked="1">
                        <!--begin::Details-->
                        <div class="d-flex flex-wrap py-5" bis_skin_checked="1">
                                                            <!--begin::Col-->
                                <div class="flex-equal me-5" bis_skin_checked="1">
                                    <table class="table table-flush fw-semibold gy-1">
                                            ...
                                            <td class="text-gray-800">Max Smith</td>
                                                                            ...
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                            <td class="text-gray-800">**** 1749</td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">Expires</td>
                                ...
                                <div class="flex-equal " bis_skin_checked="1">
                                    <table class="table table-flush fw-semibold gy-1">
                                            ...
                                            <td class="text-gray-800"><a href="#" class="text-gray-900 text-hover-primary">max@kt.com</a></td>
                                                                            ...
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">Origin</td>
                                            <td class="text-gray-800">United States of America <div class="symbol symbol-20px symbol-circle ms-2" bis_skin_checked="1"><img src="/metronic8/demo1/assets/media/flags/united-states.svg"></div></td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-muted min-w-125px w-125px">CVC check</td>
...
<div class="card card-flush pt-3 mb-5 mb-lg-10" bis_skin_checked="1">
    ...
    <div class="card-body pt-0" bis_skin_checked="1">
        <!--begin::Custom fields-->
        <div class="d-flex flex-column mb-15 fv-row" bis_skin_checked="1">
            <!--begin::Label-->
            <div class="fs-5 fw-bold form-label mb-3" bis_skin_checked="1">
                Custom fields 

                <span class="ms-2 cursor-pointer" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Add custom fields to the billing invoice." data-kt-initialized="1">
            ...
            <div class="table-responsive" bis_skin_checked="1">
                <!--begin::Table-->
                <div id="kt_create_new_custom_fields_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer" bis_skin_checked="1"><div class="table-responsive" bis_skin_checked="1"><table id="kt_create_new_custom_fields" class="table align-middle table-row-dashed fw-semibold fs-6 gy-5 dataTable no-footer">
                    <!--begin::Table head-->
                    <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0"><th class="pt-0 sorting_disabled" rowspan="1" colspan="1" style="width: 359.016px;">Field Name</th><th class="pt-0 sorting_disabled" rowspan="1" colspan="1" style="width: 364.641px;">Field Value</th><th class="pt-0 text-end sorting_disabled" rowspan="1" colspan="1" style="width: 88.0938px;">Remove</th></tr>
                    </thead>
                    <!--end::Table head-->
        ...
        <div class="d-flex flex-column mb-10 fv-row" bis_skin_checked="1">
            <!--begin::Label-->
            <div class="fs-5 fw-bold form-label mb-3" bis_skin_checked="1">
                Invoice footer

                <span class="ms-2 cursor-pointer" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-html="true" data-bs-content="Add an addition invoice footer note." data-kt-initialized="1">
                    <i class="ki-duotone ki-information fs-7"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>                </span>
            </div>
            <!--end::Label-->
        ...
        <!--begin::Option-->
        <div class="d-flex flex-column fv-row rounded-3 p-7 border border-dashed border-gray-300" bis_skin_checked="1">
            <!--begin::Label-->
            <div class="fs-5 fw-bold form-label mb-3" bis_skin_checked="1">
                Pro-rate billing

                <span class="ms-2 cursor-pointer" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-html="true" data-bs-delay-hide="1000" data-bs-content="Pro-rated billing dynamically calculates the remainder amount leftover per billing cycle that is owed. <a href='#'>Learn more</a>." data-kt-initialized="1">
                    <i class="ki-duotone ki-information fs-7"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>                </span>
            </div>
            <!--end::Label-->
