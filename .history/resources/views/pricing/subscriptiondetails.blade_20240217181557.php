                        ...
                        <div class="card-body pt-0" bis_skin_checked="1">
                            ...
                            <div id="kt_create_new_payment_method" bis_skin_checked="1">
                                ...
                                <div class="py-1" bis_skin_checked="1">
                                    ...
                                    <!--begin::Body-->
                                    <div class="collapse  fs-6 ps-10" bis_skin_checked="1">
                                        <!--begin::Details-->
                                ...
                                <div class="py-1" bis_skin_checked="1">
                                    ...
                                    <!--begin::Body-->
                                    <div id="kt_create_new_payment_method_2" class="fs-6 ps-10 collapse" bis_skin_checked="1" style="">
                                        <!--begin::Details-->
                                        <div class="d-flex flex-wrap py-5" bis_skin_checked="1">
                                            <!--begin::Col-->
                                            <div class="flex-equal me-5" bis_skin_checked="1">
                                                <table class="table table-flush fw-semibold gy-1">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">**** 9255</td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <table class="table table-flush fw-semibold gy-1">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">United Kingdom <div class="symbol symbol-20px symbol-circle ms-2" bis_skin_checked="1"><img src="/metronic8/demo1/assets/media/flags/united-kingdom.svg"></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
