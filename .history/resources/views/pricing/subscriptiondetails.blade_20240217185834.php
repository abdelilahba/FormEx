                                            ...
                                            <tbody class="text-gray-600">
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-flex btn-active-light-primary w-30px h-30px me-3" data-bs-toggle="tooltip" data-kt-action="product_remove" aria-label="Delete" data-bs-original-title="Delete" data-kt-initialized="1">
                                                            <i class="fas fa-coins fs-3"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i> </a>
                                                        <!--end::Delete-->
                                                    </td>
                                                </tr>
                                                <tr class="even">
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="text-end">
                                                        <!--begin::Delete-->
                                                        <a href="#" class="btn btn-icon btn-flex btn-active-light-primary w-30px h-30px me-3" data-bs-toggle="tooltip" data-kt-action="product_remove" aria-label="Delete" data-bs-original-title="Delete" data-kt-initialized="1">
                                                            <i class="fas fa-trash fs-3"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i> </a>
                                                        <!--end::Delete-->
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <div id="kt_create_new_payment_method_1" class="collapse show fs-6 ps-10" bis_skin_checked="1">
                                        ...
                                        <div class="d-flex flex-wrap py-5" bis_skin_checked="1">
                                            <p style="font-size: 1.2rem;" class="mb-5">
                                                Prière d'effectuer un versement en espèces ou un virement bancaire, de la somme de <span style="color: red;">598.80 DH </span> sur le compte ci-dessous sans oublier de nous faxer l'ordre dudit virement/versement au 05 22 49 19 40.
                                            </p>
                                            <!--begin::Col-->
                                        ...
                                        <p>
                                            Merci de prendre note du numéro de votre commande: <span style="color: red;">147626</span>
                                        </p>
                                        <!--end::Details-->
                                    </div>
                                    <!--end::Body-->
                                    ...
                                    <div id="kt_create_new_payment_method_2" class="fs-6 ps-10 collapse" bis_skin_checked="1">
                                        ...
                                        <div class="d-flex flex-wrap py-5" bis_skin_checked="1">
                                            ...
                                            <div class=" me-5" bis_skin_checked="1">
                                                <p style="font-size: 1.2rem;" class="mb-5">
                                                    Le system de sécurisation des paiments électroniques mis en place par le Centre Monétique Interbancaire (CMI) est certifié par les Banques Marocaines ainsi que les organismes internationaux VISA et MasterCard </p>
                                            </div>
                                            <hr>
                                            <div>

                                                Pour Payer 837.60DH en utilisant ce service , cliquez sur le boutons ci-dessous <br>
                                            </div>
