...
.form-check {
        ...
        /* Ensure that text direction does not affect layout */
        direction: ltr;
    }

    .form-check-input {
        /* Adjust margin if needed to add space between the checkbox and the label */
        margin-right: 0.5rem;
    }

    /* If you are using RTL for Arabic pages and this causes issues, force LTR on the label */
    .form-check-label {
        text-align: left;
        direction: ltr; /* This forces the label to follow LTR convention */
    }
