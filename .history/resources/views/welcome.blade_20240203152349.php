...
<div class="container mt-5">
    ...
    <select class="form-select" placeholder="..." id="kt_docs_select2_country">
        ...
        <option value="AF" data-kt-select2-country="assets/media/flags/morroco.svg">Afghanistan</option>
        <option value="AX" data-kt-select2-country="assets/media/flags/french.svg">Aland Islands</option>
        ...
    </select>
