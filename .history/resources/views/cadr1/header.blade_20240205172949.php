        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper" bis_skin_checked="1">
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}" bis_skin_checked="1">
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true" bis_skin_checked="1">
                    ...
                    <div class="menu-item menu-accordion" bis_skin_checked="1">
                        <!--begin:Menu link-->

                              <span class="menu-link" >
                                  <a href="/projet" id="link"><span  class="menu-title">Mode &nbsp; <span id="affichage1"> </span> </span> </a>
                              </span>
                    ...
                    <div class="menu-item menu-accordion" bis_skin_checked="1">
                        <!--begin:Menu link-->
                        <a class="menu-link" href="#" onclick="maptest()">

                            <span class="menu-title" id="mode" >Mode &nbsp;   <span id="affichage"></span></span>
                        </a>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                        <!--end:Menu sub-->
...
{{--                        <!--begin:Menu link-->--}}
{{--                        <span class="menu-link">--}}
{{--											<span class="menu-title">Bornes</span>--}}
...
{{--                        <!--begin:Menu link-->--}}
{{--                        <span class="menu-link">--}}
{{--											<span class="menu-title">Détails</span>--}}
{{--											<span class="menu-arrow d-lg-none"></span>--}}
{{--										</span>--}}
{{--                        <!--end:Menu link-->--}}
{{--                        <!--begin:Menu sub-->--}}
...
{{--                        <!--begin:Menu link-->--}}
{{--                        <span class="menu-link">--}}
{{--											<span class="menu-title">Brigades</span>--}}
{{--											<span class="menu-arrow d-lg-none"></span>--}}
{{--										</span>--}}
{{--                        <!--end:Menu link-->--}}
{{--                        <!--begin:Menu sub-->--}}
...
{{--                        <!--begin:Menu link-->--}}
{{--                        <span class="menu-link">--}}
{{--											<span class="menu-title">Autres listes</span>--}}
{{--											<span class="menu-arrow d-lg-none"></span>--}}
{{--										</span>--}}
{{--                        <!--end:Menu link-->--}}
{{--                        <!--begin:Menu sub-->--}}
...
{{--                                        <img class="mw-100 mh-200px" alt="image" src="/metronic8/demo1/assets/media/illustrations/sketchy-1/0.png">--}}
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
...
<path d="M3 21C3.95728 17.9237 6.41998 17 12 17C17.58 17 20.0427 17.9237 21 21" stroke="#323232" stroke-width="2" stroke-linecap="round"/>
                    ...
                    <!--begin::Menu toggle-->
                    <!--begin::Menu-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-900 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-300px" data-kt-menu="true" data-kt-element="theme-mode-menu" bis_skin_checked="1">
                        ...
                        <div class="menu-item px-3" bis_skin_checked="1">
                            <div class="menu-content d-flex align-items-center px-3" bis_skin_checked="1">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bolder d-flex align-items-center fs-5">  @if (auth()->check() && auth()->user()->name != null ) {{ Auth::user()->name }}  @else Null @endif
                                    </div>
                                    <a href="#" class="fw-bold text-muted text-hover-primary fs-7"> @if (auth()->check() && auth()->user()->email != null ) {{ Auth::user()->email }} @else Null @endif </a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
