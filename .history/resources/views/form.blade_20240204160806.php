   ...
   <form action="{{ route('submit.form') }}"  method="POST">
      ...
      <div class="form-group">
         ...
         <div  style="width: 66% !important;">
            <select class="form-select" name="country"  id="kt_docs_select2_country">
      ...
      <button type="submit" class="btn btn-gray"><i class="fas fa-phone pr-2" aria-hidden="true"></i>Parler à un conseiller</button>
