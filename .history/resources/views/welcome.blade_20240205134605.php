...
<script>
    ...
    // Format options
    function generateOptionFormat(id) {
    return function(item) {
        ...
        // Use the provided id to dynamically get the attribute for the image URL
        var imgUrl = item.element.getAttribute(id);
        var template = '';
...
$('#kt_docs_select2_country').select2({
    templateSelection: generateOptionFormat('data-kt-select2-country'),
    templateResult: generateOptionFormat('data-kt-select2-country')
});

// Initialize Select2 for the second dropdown with a potentially different attribute ID
$('#kt_docs_select3_country').select2({
    templateSelection: generateOptionFormat('data-kt-select3-country'),
    templateResult: generateOptionFormat('data-kt-select3-country')
});
</script>
