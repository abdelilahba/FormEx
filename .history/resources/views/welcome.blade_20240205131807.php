...
<form action="{{ route('language.change') }}" method="POST" class="d-inline">
            @csrf
            <select name="language" onchange="this.form.submit()" class="form-select form-select-sm" id="kt_docs_select2_country">
               <option value="AF"  data-kt-select2-country="assets/media/flags/morocco.svg">العربية</option>
