...
<input type="checkbox" class="form-check-input" id="agreement" name="agreement" required style="order: 1;">

<!-- Label comes after the checkbox -->
<label class="form-check-label" for="agreement" style="order: 2;">{{ __('messages.accept') }} <a href="{{ route('terms', app()->getLocale()) }}">{{ __('messages.terms_agreement') }}</a>.</label>
