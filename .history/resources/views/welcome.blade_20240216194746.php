...
<div class="whatsapp-contact-section text-center mt-4">
    <a href="https://wa.me/212666653437" class="whatsapp-contact-link" target="_blank">
        <img src="{{ asset('path/to/whatsapp-icon.png') }}" alt="WhatsApp" class="whatsapp-icon" />
        <span class="whatsapp-number">+212666653437</span>
        <span class="whatsapp-text">7 jours d'essai gratuit</span>
    </a>
</div>
