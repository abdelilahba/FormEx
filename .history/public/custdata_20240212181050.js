                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        if (row.state === "0") {
                            ...
                            buttonHTML = `<button class="btn btn-sm btn-success toggle-activation-btn"  data-action="activate"  data-id="${row.id}" style="text-aling:center" title="Activate Customer"><i class="fa fa-check-circle"></i> Activate</button>`;
                        } else {
                            buttonHTML = `<button class="btn btn-sm btn-danger toggle-activation-btn"  data-action="deactivate" data-id="${row.id}"  style="text-align:center" title="Deactivate Customer"><i class="fa fa-ban"></i> Deactivate</button>`; // No button for active or refused states
                        }
                        return buttonHTML;
                    },
                },
