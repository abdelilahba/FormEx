            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        var deleteBtn = `<a href="#" class="badge badge-danger p-2" title="Delete" data-kt-docs-table-filter="delete_row"  return false;"><i class="fas fa-trash-alt"></i></a>`;
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            d.addEventListener('click', function (e) {
                ...
                const customerId = parent.getAttribute('data-customer-id'); // Ensure each row has a data-customer-id attribute
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '/customers/delet/' + customerId,
                            type: 'DELETE',
                            data: {
                                "_token": "{{ csrf_token() }}",
                            },
