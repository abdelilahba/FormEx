...
var KTDatatablesServerSide = function () {
    ...
    var deleteSelected = function() {
        const selectedRows = dt.rows('.selected').data(); // Get all selected rows
       // console.log(selectedRows);
        ...
        selectedRows.each(function(value, index){
            selectedIds.push(value.id); // Assuming 'id' is the name of the property that holds your unique identifier
        });
    ...
    var initEventListeners = function() {
        ...
        document.querySelector('[data-kt-docs-table-select="delete_selected"]').addEventListener('click', function() {
            deleteSelected();
        });
    };
