            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        var editBtn = `<a href="javascript:void(0);" onclick="openEditModal(customerId);" class="badge badge-primary p-2 edit-btn" data-id="${row.id}" title="Edit"><i class="fas fa-edit"></i></a>`;
