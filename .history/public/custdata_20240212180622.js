                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if(row.state === "0") { // Show activate button only for pending (state 0) customers
                            ...
                            buttonHTML =`<button class="btn btn-sm btn-danger toggle-activation-btn"  data-action="deactivate" style="text-align:center" title="Deactivate Customer"><i class="fa fa-ban"></i> Deactivate</button>`;; // No button for active or refused states
                        }
                        return buttonHTML
                    }
                },
