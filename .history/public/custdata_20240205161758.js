                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if(row.state === "0") { // Show activate button only for pending (state 0) customers
                            return `<button class="btn btn-sm btn-outline-success activate-btn" data-id="${row.id}" title="Activate Customer"><i class="fa fa-check-circle"></i> Activate</button>`;
                        } else  {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `
                            <a href="#" class="badge badge-primary p-2" title="Edit"><i class="fas fa-edit"></i></a>
                            <a href="#" class="badge badge-danger p-2" title="Delete"><i class="fas fa-trash-alt"></i></a>
                        `;
                    },
                }
