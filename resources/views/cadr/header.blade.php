<div id="kt_app_header" class="app-header" bis_skin_checked="1">
    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container" bis_skin_checked="1">
        <!--begin::sidebar mobile toggle-->
        <div class="d-flex align-items-center d-lg-none ms-n2 me-2" title="Show sidebar menu" bis_skin_checked="1">
            <div class="btn btn-icon btn-active-color-primary w-35px h-35px" id="kt_app_sidebar_mobile_toggle" bis_skin_checked="1">
        ...
        <!--begin::Mobile logo-->
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0" bis_skin_checked="1">
            <a href="/metronic8/demo1/../demo1/index.html" class="d-lg-none">
                <img alt="Logo" src="https://preview.keenthemes.com/metronic8/demo1/assets/media/logos/default-small.svg" class="h-30px">
            </a>
        </div>
        <!--end::Mobile logo-->
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper" bis_skin_checked="1">
            <!--begin::Menu wrapper-->
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}" bis_skin_checked="1">
                <!--begin::Menu-->
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true" bis_skin_checked="1">
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2" bis_skin_checked="1">
                        <!--begin:Menu link-->
                        ...
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-850px" bis_skin_checked="1">
                            <!--begin:Dashboards menu-->
                            <div class="menu-state-bg menu-extended overflow-hidden" data-kt-menu-dismiss="true" bis_skin_checked="1">
                                <!--begin:Row-->
                                <div class="row" bis_skin_checked="1">
                                    <!--begin:Col-->
                                    <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6" bis_skin_checked="1">
                                        <!--begin:Row-->
                                        <div class="row" bis_skin_checked="1">
                                            <!--begin:Col-->
                                            <div class="col-lg-6 mb-3" bis_skin_checked="1">
                                                ...
                                                <div class="menu-item p-0 m-0" bis_skin_checked="1">
                                                    <!--begin:Menu link-->
                                                    <a href="/metronic8/demo1/../demo1/index.html" class="menu-link active">
                                            ...
                                            <div class="col-lg-6 mb-3" bis_skin_checked="1">
                                                ...
                                                <div class="menu-item p-0 m-0" bis_skin_checked="1">
                                                    <!--begin:Menu link-->
                                                    <a href="/metronic8/demo1/../demo1/dashboards/ecommerce.html" class="menu-link">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                        ...
                                        <!--end:Row-->
                                        <div class="separator separator-dashed mx-5 my-5" bis_skin_checked="1"></div>
                                        <!--begin:Landing-->
                                        <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5" bis_skin_checked="1">
                                            <div class="d-flex flex-column me-5" bis_skin_checked="1">
                                                <div class="fs-6 fw-bold text-gray-800" bis_skin_checked="1">Landing Page Template</div>
                                                <div class="fs-7 fw-semibold text-muted" bis_skin_checked="1">Onpe page landing template with pricing &amp; others</div>
                                            </div>
                                            <a href="/metronic8/demo1/../demo1/landing.html" class="btn btn-sm btn-primary fw-bold">Explore</a>
                                        </div>
                                        <!--end:Landing-->
                                    </div>
                                    <!--end:Col-->
                                    <!--begin:Col-->
                                    <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end" bis_skin_checked="1">
                                        <!--begin:Heading-->
                    ...
                    <!--end:Menu item-->
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2" bis_skin_checked="1">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                        ...
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0" bis_skin_checked="1">
                            <!--begin:Pages menu-->
                            <div class="menu-active-bg px-4 px-lg-0" bis_skin_checked="1">
                                <!--begin:Tabs nav-->
                                <div class="d-flex w-100 overflow-auto" bis_skin_checked="1">
                                    <ul class="nav nav-stretch nav-line-tabs fw-bold fs-6 p-0 p-lg-10 flex-nowrap flex-grow-1" role="tablist">
                                        ...
                                        <li class="nav-item mx-lg-1" role="presentation">
                                            <a class="nav-link py-3 py-lg-6 active text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_pages" aria-selected="true" role="tab">General</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1" role="presentation">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_account" aria-selected="false" tabindex="-1" role="tab">Account</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1" role="presentation">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_authentication" aria-selected="false" tabindex="-1" role="tab">Authentication</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1" role="presentation">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_utilities" aria-selected="false" tabindex="-1" role="tab">Utilities</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1" role="presentation">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_widgets" aria-selected="false" tabindex="-1" role="tab">Widgets</a>
                                        </li>
                                        <!--end:Nav item-->
                                    </ul>
                                </div>
                                <!--end:Tabs nav-->
                                <!--begin:Tab content-->
                                <div class="tab-content py-4 py-lg-8 px-lg-7" bis_skin_checked="1">
                                    <!--begin:Tab pane-->
                                    <div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages" bis_skin_checked="1" role="tabpanel">
                                        <!--begin:Row-->
                                        <div class="row" bis_skin_checked="1">
                                            <!--begin:Col-->
                                            <div class="col-lg-8" bis_skin_checked="1">
                                                ...
                                                <div class="row" bis_skin_checked="1">
                                                    <!--begin:Col-->
                                                    <div class="col-lg-3 mb-6 mb-lg-0" bis_skin_checked="1">
                                                        <!--begin:Menu heading-->
                                            ...
                                            <div class="col-lg-4" bis_skin_checked="1">
                                                <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/600x600/img-82.jpg" class="rounded mw-100" alt="">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Row-->
                                    ...
                                    <!--end:Tab pane-->
                                    <!--begin:Tab pane-->
                                    <div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account" bis_skin_checked="1" role="tabpanel">
                                        <!--begin:Row-->
                                        <div class="row" bis_skin_checked="1">
                                            <!--begin:Col-->
                                            <div class="col-lg-5 mb-6 mb-lg-0" bis_skin_checked="1">
                                                <!--begin:Row-->
                                                <div class="row" bis_skin_checked="1">
                                                    <!--begin:Col-->
                                            ...
                                            <div class="col-lg-7" bis_skin_checked="1">
                                                <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/900x600/46.jpg" class="rounded mw-100" alt="">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Row-->
                                    ...
                                    <!--end:Tab pane-->
                                    <!--begin:Tab pane-->
                                    <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_authentication" bis_skin_checked="1" role="tabpanel">
                                        <!--begin:Row-->
                                        <div class="row" bis_skin_checked="1">
                                            <!--begin:Col-->
                                            <div class="col-lg-3 mb-6 mb-lg-0" bis_skin_checked="1">
                                                ...
                                                <div class="mb-6" bis_skin_checked="1">
                                                    ...
                                                    <div class="menu-item p-0 m-0" bis_skin_checked="1">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/authentication/layouts/corporate/two-steps.html" class="menu-link">
                                                ...
                                                <div class="mb-0" bis_skin_checked="1">
                                                    ...
                                                    <div class="menu-item p-0 m-0" bis_skin_checked="1">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/authentication/layouts/overlay/two-steps.html" class="menu-link">
                                                            <span class="menu-title">Two-steps</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                                            ...
                                            <div class="col-lg-3 mb-6 mb-lg-0" bis_skin_checked="1">
                                                ...
                                                <div class="mb-6" bis_skin_checked="1">
                                                    ...
                                                    <div class="menu-item p-0 m-0" bis_skin_checked="1">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/authentication/layouts/creative/two-steps.html" class="menu-link">
                                                            <span class="menu-title">Two-steps</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                                                ...
                                                <div class="mb-6" bis_skin_checked="1">
                                                    ...
                                                    <div class="menu-item p-0 m-0" bis_skin_checked="1">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/authentication/layouts/fancy/two-steps.html" class="menu-link">
                                                            <span class="menu-title">Two-steps</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    </div>
                                            ...
                                            <div class="col-lg-3 mb-6 mb-lg-0" bis_skin_checked="1">
                                                ...
                                                <div class="mb-0" bis_skin_checked="1">
                                                    ...
                                                    <div class="menu-item p-0 m-0" bis_skin_checked="1">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/authentication/extended/two-factor-auth.html" class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0" bis_skin_checked="1">
                                                        <!--begin:Menu link-->
                                                        <a href="/metronic8/demo1/../demo1/authentication/extended/coming-soon.html" class="menu-link">
                                    ...
                                    <!--end:Tab pane-->
                                    <!--begin:Tab pane-->
                                    <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities" bis_skin_checked="1" role="tabpanel">
                                        <!--begin:Row-->
                                        <div class="row" bis_skin_checked="1">
                                            <!--begin:Col-->
                                            <div class="col-lg-7" bis_skin_checked="1">
                                                ...
                                                <div class="row" bis_skin_checked="1">
                                                    <!--begin:Col-->
                                                    <div class="col-lg-4 mb-6 mb-lg-0" bis_skin_checked="1">
                                                        <!--begin:Menu section-->
                                                        <div class="mb-0" bis_skin_checked="1">
                                                            <!--begin:Menu heading-->
                                            ...
                                            <!--end:Col-->
                                            <!--begin:Col-->
                                            <div class="col-lg-5 pe-lg-5" bis_skin_checked="1">
                                                <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/600x600/img-84.jpg" class="rounded mw-100" alt="">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Row-->
                                    ...
                                    <!--end:Tab pane-->
                                    <!--begin:Tab pane-->
                                    <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets" bis_skin_checked="1" role="tabpanel">
                                        <!--begin:Row-->
                                        <div class="row" bis_skin_checked="1">
                                            <!--begin:Col-->
                                            <div class="col-lg-4 mb-6 mb-lg-0" bis_skin_checked="1">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-8" bis_skin_checked="1">
                                                <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/900x600/44.jpg" class="rounded mw-100" alt="">
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Row-->
                    ...
                    <!--end:Menu item-->
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2" bis_skin_checked="1">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                        ...
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px" bis_skin_checked="1">
                            <!--begin:Menu item-->
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion" bis_skin_checked="1">
                                <!--begin:Menu link-->
                                <span class="menu-link">
                                ...
                                <!--end:Menu link-->
                                <!--begin:Menu sub-->
                                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" bis_skin_checked="1">
                                    <!--begin:Menu item-->
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion" bis_skin_checked="1">
                                ...
                                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px" bis_skin_checked="1">
                                    ...
                                    <!--end:Menu item-->
                                    <!--begin:Menu item-->
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion menu-sub-indention" bis_skin_checked="1">
                                        <!--begin:Menu link-->
                                        <span class="menu-link">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2" bis_skin_checked="1">
                        ...
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-850px" bis_skin_checked="1">
                            <!--begin:Dashboards menu-->
                            <div class="menu-active-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true" bis_skin_checked="1">
                                <!--begin:Row-->
                                <div class="row" bis_skin_checked="1">
                                    <!--begin:Col-->
                                    <div class="col-lg-6" bis_skin_checked="1">
                                        ...
                                        <!--end:Row-->
                                        <div class="separator separator-dashed mx-lg-5 mt-2 mb-6" bis_skin_checked="1"></div>
                                        <!--begin:Layout Builder-->
                                        <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mb-5 mb-lg-0 mx-lg-5" bis_skin_checked="1">
                                            <div class="d-flex flex-column me-5" bis_skin_checked="1">
                                                <div class="fs-6 fw-bold text-gray-800" bis_skin_checked="1">Layout Builder</div>
                                                <div class="fs-7 fw-semibold text-muted" bis_skin_checked="1">Customize, preview and export</div>
                                            </div>
                                            <a href="/metronic8/demo1/../demo1/layout-builder.html" class="btn btn-sm btn-primary fw-bold">Try Builder</a>
                                        </div>
                                        <!--end:Layout Builder-->
                                    </div>
                                    <!--end:Col-->
                                    <!--begin:Col-->
                                    <div class="col-lg-6 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center" bis_skin_checked="1">
                                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/900x600/45.jpg" class="rounded mw-100" alt="">
                                    </div>
                                    <!--end:Col-->
                                </div>
                                <!--end:Row-->
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2" bis_skin_checked="1">
                        ...
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px" bis_skin_checked="1">
                            <!--begin:Menu item-->
                            <div class="menu-item" bis_skin_checked="1">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="https://preview.keenthemes.com/html/metronic/docs/base/utilities" target="blank" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" data-bs-original-title="Check out over 200 in-house components, plugins and ready for use solutions" data-kt-initialized="1">
													<span class="menu-icon">
														<!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
														<span class="svg-icon svg-icon-3">
															<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="menu-item" bis_skin_checked="1">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="https://preview.keenthemes.com/html/metronic/docs" target="blank" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" data-bs-original-title="Check out the complete documentation" data-kt-initialized="1">
													<span class="menu-icon">
            ...
            <div class="app-navbar flex-shrink-0" bis_skin_checked="1">
                <!--begin::Search-->
                <div class="app-navbar-item align-items-stretch ms-1 ms-lg-3" bis_skin_checked="1">
                    <!--begin::Search-->
                    <div id="kt_header_search" class="header-search d-flex align-items-stretch" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-overflow="false" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end" data-kt-search="true" bis_skin_checked="1">
                        <!--begin::Search toggle-->
                        <div class="d-flex align-items-center" data-kt-search-element="toggle" id="kt_header_search_toggle" bis_skin_checked="1">
                            <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" bis_skin_checked="1">
                        ...
                        <!--end::Search toggle-->
                        <!--begin::Menu-->
                        <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px" data-kt-menu="true" bis_skin_checked="1">
                            <!--begin::Wrapper-->
                            <div data-kt-search-element="wrapper" bis_skin_checked="1">
                                ...
                                <form data-kt-search-element="form" class="w-100 position-relative mb-3" autocomplete="off">
                                    ...
                                    <!--end::Reset-->
                                    <!--begin::Toolbar-->
                                    <div class="position-absolute top-50 end-0 translate-middle-y" data-kt-search-element="toolbar" bis_skin_checked="1">
                                        <!--begin::Preferences toggle-->
                                        <div data-kt-search-element="preferences-show" class="btn btn-icon w-20px btn-sm btn-active-color-primary me-1" data-bs-toggle="tooltip" aria-label="Show search preferences" data-bs-original-title="Show search preferences" data-kt-initialized="1" bis_skin_checked="1">
                                        ...
                                        <div data-kt-search-element="advanced-options-form-show" class="btn btn-icon w-20px btn-sm btn-active-color-primary" data-bs-toggle="tooltip" aria-label="Show more search options" data-bs-original-title="Show more search options" data-kt-initialized="1" bis_skin_checked="1">
                                ...
                                <!--end::Form-->
                                <!--begin::Separator-->
                                <div class="separator border-gray-200 mb-6" bis_skin_checked="1"></div>
                                <!--end::Separator-->
                                <!--begin::Recently viewed-->
                                <div data-kt-search-element="results" class="d-none" bis_skin_checked="1">
                                    <!--begin::Items-->
                                    <div class="scroll-y mh-200px mh-lg-350px" bis_skin_checked="1">
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-column justify-content-start fw-semibold" bis_skin_checked="1">
                                ...
                                <!--end::Recently viewed-->
                                <!--begin::Recently viewed-->
                                <div class="mb-5" data-kt-search-element="main" bis_skin_checked="1">
                                    <!--begin::Heading-->
                                    <div class="d-flex flex-stack fw-semibold mb-4" bis_skin_checked="1">
                                        <!--begin::Label-->
                                    ...
                                    <!--end::Heading-->
                                    <!--begin::Items-->
                                    <div class="scroll-y mh-200px mh-lg-325px" bis_skin_checked="1">
                                        <!--begin::Item-->
                                ...
                                <div data-kt-search-element="empty" class="text-center d-none" bis_skin_checked="1">
                                    <!--begin::Icon-->
                                    <div class="pt-10 pb-10" bis_skin_checked="1">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Message-->
                                    <div class="pb-15 fw-semibold" bis_skin_checked="1">
                                        <h3 class="text-gray-600 fs-5 mb-2">No result found</h3>
                                        <div class="text-muted fs-7" bis_skin_checked="1">Please try again with a different query</div>
                                    </div>
                                    <!--end::Message-->
                                </div>
                                <!--end::Empty-->
                            ...
                            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                ...
                                <div class="mb-5" bis_skin_checked="1">
                                    <!--begin::Radio group-->
                                    <div class="nav-group nav-group-fluid" bis_skin_checked="1">
                                        <!--begin::Option-->
                                        <label>
                                ...
                                <!--begin::Input group-->
                                <div class="mb-5" bis_skin_checked="1">
                                    <select name="timezone" aria-label="Select a Timezone" data-control="select2" data-placeholder="date_period" class="form-select form-select-sm form-select-solid select2-hidden-accessible" data-select2-id="select2-data-1-wu27" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                        <option value="next" data-select2-id="select2-data-3-020e">Within the next</option>
                                        <option value="last">Within the last</option>
                                        <option value="between">Between</option>
                                        <option value="on">On</option>
                                    </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-2-tijp" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-sm form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-timezone-95-container" aria-controls="select2-timezone-95-container"><span class="select2-selection__rendered" id="select2-timezone-95-container" role="textbox" aria-readonly="true" title="Within the next">Within the next</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="row mb-8" bis_skin_checked="1">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-6" bis_skin_checked="1">
                                        <select name="date_typer" aria-label="Select a Timezone" data-control="select2" data-placeholder="Period" class="form-select form-select-sm form-select-solid select2-hidden-accessible" data-select2-id="select2-data-4-cdds" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                            <option value="days" data-select2-id="select2-data-6-mofs">Days</option>
                                            <option value="weeks">Weeks</option>
                                            <option value="months">Months</option>
                                            <option value="years">Years</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-5-z1ww" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-sm form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-date_typer-4x-container" aria-controls="select2-date_typer-4x-container"><span class="select2-selection__rendered" id="select2-date_typer-4x-container" role="textbox" aria-readonly="true" title="Days">Days</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                            ...
                            <form data-kt-search-element="preferences" class="pt-1 d-none">
                                ...
                                <!--end::Heading-->
                                <!--begin::Input group-->
                                <div class="pb-4 border-bottom" bis_skin_checked="1">
                                ...
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="py-4 border-bottom" bis_skin_checked="1">
                                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                ...
                                <!--end::Input group-->
                                <!--begin::Actions-->
                                <div class="d-flex justify-content-end pt-7" bis_skin_checked="1">
                ...
                <!--end::Search-->
                <!--begin::Activities-->
                <div class="app-navbar-item ms-1 ms-lg-3" bis_skin_checked="1">
                    <!--begin::Drawer toggle-->
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" id="kt_activities_toggle" bis_skin_checked="1">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                        <span class="svg-icon svg-icon-1">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												<rect x="8" y="9" width="3" height="10" rx="1.5" fill="currentColor"></rect>
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" bis_skin_checked="1">
                    <!--begin::Menu- wrapper-->
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" bis_skin_checked="1">
                    ...
                    <!--begin::Menu-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" bis_skin_checked="1">
                        <!--begin::Heading-->
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('https://preview.keenthemes.com/metronic8/demo1/assets/media/misc/menu-header-bg.jpg')" bis_skin_checked="1">
                            <!--begin::Title-->
                        ...
                        <div class="tab-content" bis_skin_checked="1">
                            <!--begin::Tab panel-->
                            <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel" bis_skin_checked="1">
                                <!--begin::Items-->
                                <div class="scroll-y mh-325px my-5 px-8" bis_skin_checked="1">
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack py-4" bis_skin_checked="1">
                                        <!--begin::Section-->
                                        <div class="d-flex align-items-center" bis_skin_checked="1">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-35px me-4" bis_skin_checked="1">
                                            ...
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="mb-0 me-2" bis_skin_checked="1">
                                                <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Project Alice</a>
                                                <div class="text-gray-400 fs-7" bis_skin_checked="1">Phase 1 development</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4" bis_skin_checked="1">
                                        ...
                                        <div class="d-flex align-items-center" bis_skin_checked="1">
                                            ...
                                            <div class="mb-0 me-2" bis_skin_checked="1">
                                                ...
                                                <div class="text-gray-400 fs-7" bis_skin_checked="1">Confidential staff documents</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4" bis_skin_checked="1">
                                        ...
                                        <div class="d-flex align-items-center" bis_skin_checked="1">
                                            ...
                                            <div class="mb-0 me-2" bis_skin_checked="1">
                                                ...
                                                <div class="text-gray-400 fs-7" bis_skin_checked="1">Corporeate staff profiles</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4" bis_skin_checked="1">
                                        ...
                                        <div class="d-flex align-items-center" bis_skin_checked="1">
                                            ...
                                            <div class="mb-0 me-2" bis_skin_checked="1">
                                                ...
                                                <div class="text-gray-400 fs-7" bis_skin_checked="1">New frontend admin theme</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4" bis_skin_checked="1">
                                        ...
                                        <div class="d-flex align-items-center" bis_skin_checked="1">
                                            ...
                                            <div class="mb-0 me-2" bis_skin_checked="1">
                                                ...
                                                <div class="text-gray-400 fs-7" bis_skin_checked="1">Product launch status update</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4" bis_skin_checked="1">
                                        ...
                                        <div class="d-flex align-items-center" bis_skin_checked="1">
                                            ...
                                            <div class="mb-0 me-2" bis_skin_checked="1">
                                                ...
                                                <div class="text-gray-400 fs-7" bis_skin_checked="1">Collection of banner images</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4" bis_skin_checked="1">
                                        ...
                                        <div class="d-flex align-items-center" bis_skin_checked="1">
                                            ...
                                            <div class="mb-0 me-2" bis_skin_checked="1">
                                                ...
                                                <div class="text-gray-400 fs-7" bis_skin_checked="1">Collection of SVG icons</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                ...
                                <!--end::Items-->
                                <!--begin::View more-->
                                <div class="py-3 text-center border-top" bis_skin_checked="1">
                                    <a href="/metronic8/demo1/../demo1/pages/user-profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View All
                            ...
                            <!--end::Tab panel-->
                            <!--begin::Tab panel-->
                            <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel" bis_skin_checked="1">
                                <!--begin::Wrapper-->
                                <div class="d-flex flex-column px-9" bis_skin_checked="1">
                                    ...
                                    <div class="pt-10 pb-0" bis_skin_checked="1">
                                        ...
                                        <!--end::Title-->
                                        <!--begin::Text-->
                                        <div class="text-center text-gray-600 fw-semibold pt-1" bis_skin_checked="1">Outlines keep you honest. They stoping you from amazing poorly about drive</div>
                                        <!--end::Text-->
                                        <!--begin::Action-->
                            ...
                            <!--end::Tab panel-->
                            <!--begin::Tab panel-->
                            <div class="tab-pane fade" id="kt_topbar_notifications_3" role="tabpanel" bis_skin_checked="1">
                                <!--begin::Items-->
                                <div class="scroll-y mh-325px my-5 px-8" bis_skin_checked="1">
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack py-4" bis_skin_checked="1">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" bis_skin_checked="1">
                    <!--begin::Menu wrapper-->
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative" id="kt_drawer_chat_toggle" bis_skin_checked="1">
                        <!--begin::Svg Icon | path: icons/duotune/communication/com012.svg-->
                        <span class="svg-icon svg-icon-1">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path opacity="0.3" d="M20 3H4C2.89543 3 2 3.89543 2 5V16C2 17.1046 2.89543 18 4 18H4.5C5.05228 18 5.5 18.4477 5.5 19V21.5052C5.5 22.1441 6.21212 22.5253 6.74376 22.1708L11.4885 19.0077C12.4741 18.3506 13.6321 18 14.8167 18H20C21.1046 18 22 17.1046 22 16V5C22 3.89543 21.1046 3 20 3Z" fill="currentColor"></path>
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" bis_skin_checked="1">
                    ...
                    <!--begin::My apps-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-100 w-sm-350px" data-kt-menu="true" bis_skin_checked="1" style="">
                        <!--begin::Card-->
                        <div class="card" bis_skin_checked="1">
                            <!--begin::Card header-->
                            <div class="card-header" bis_skin_checked="1">
                                <!--begin::Card title-->
                                <div class="card-title" bis_skin_checked="1">My Apps</div>
                                <!--end::Card title-->
                                <!--begin::Card toolbar-->
                            ...
                            <div class="card-body py-5" bis_skin_checked="1">
                                <!--begin::Scroll-->
                                <div class="mh-450px scroll-y me-n5 pe-5" bis_skin_checked="1">
                                    <!--begin::Row-->
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" bis_skin_checked="1">
                    ...
                    <!--begin::Menu toggle-->
                    <!--begin::Menu-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px" data-kt-menu="true" data-kt-element="theme-mode-menu" bis_skin_checked="1">
                        <!--begin::Menu item-->
                ...
                <!--end::Theme mode-->
                <!--begin::User menu-->
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle" bis_skin_checked="1">
                    <!--begin::Menu wrapper-->
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" bis_skin_checked="1">
                        <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/avatars/300-1.jpg" alt="user">
                    </div>
                    <!--begin::User account menu-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true" bis_skin_checked="1">
                        <!--begin::Menu item-->
                        <div class="menu-item px-3" bis_skin_checked="1">
                            <div class="menu-content d-flex align-items-center px-3" bis_skin_checked="1">
                                <!--begin::Avatar-->
                                ...
                                <!--begin::Username-->
                                <div class="d-flex flex-column" bis_skin_checked="1">
                                    <div class="fw-bold d-flex align-items-center fs-5" bis_skin_checked="1">Max Smith
                        ...
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0" bis_skin_checked="1">
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0" bis_skin_checked="1">
                            <a href="#" class="menu-link px-5">
												...
												<img class="w-15px h-15px rounded-1 ms-2" src="https://preview.keenthemes.com/metronic8/demo1/assets/media/flags/united-states.svg" alt=""></span></span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4" bis_skin_checked="1">
                                <!--begin::Menu item-->
                                ...
                                <div class="menu-item px-3" bis_skin_checked="1">
                                    <a href="/metronic8/demo1/../demo1/account/settings.html" class="menu-link d-flex px-5">
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="https://preview.keenthemes.com/metronic8/demo1/assets/media/flags/germany.svg" alt="">
													</span>German</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3" bis_skin_checked="1">
                                    <a href="/metronic8/demo1/../demo1/account/settings.html" class="menu-link d-flex px-5">
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="https://preview.keenthemes.com/metronic8/demo1/assets/media/flags/japan.svg" alt="">
													</span>Japanese</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3" bis_skin_checked="1">
                                    <a href="/metronic8/demo1/../demo1/account/settings.html" class="menu-link d-flex px-5">
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="https://preview.keenthemes.com/metronic8/demo1/assets/media/flags/france.svg" alt="">
													</span>French</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5" bis_skin_checked="1">
                            <a href="/metronic8/demo1/../demo1/authentication/layouts/corporate/sign-in.html" class="menu-link px-5">Sign Out</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                ...
                <div class="app-navbar-item d-lg-none ms-2 me-n3" title="Show header menu" bis_skin_checked="1">
                    <div class="btn btn-icon btn-active-color-primary w-35px h-35px" id="kt_app_header_menu_toggle" bis_skin_checked="1">
