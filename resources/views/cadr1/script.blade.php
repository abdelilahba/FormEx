...
{{--<script src="{{asset('Datatable/parcelle/export.js')}}  "></script>--}}
...
<script src="https://www.paypal.com/sdk/js?client-id=AZrXRVbJojrcdfl2AB0PJvwyfWAcH7CUDIJ1UrWpzD2855iekRoVihL4d_qPKjPL5c6ltAuGxQjsOkEl&currency=USD"></script>
