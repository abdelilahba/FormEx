...
class ProfileCompletionController extends Controller
{
    ...
    public function subscribe($locale, $random){
    ...
    {
        $randomNumber = $request->input('random_number'); // Assuming this comes from your form

        $customer = Customer::where('random_number', $randomNumber)->first();
