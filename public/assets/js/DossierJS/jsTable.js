...
var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        ...
        dt = $("#kt_datatable_example_1").DataTable({
            ...
            ajax: {
                url: "http://127.0.0.1:8000/api/dossiers",
            },
            columns: [
                { data: 'id_dossier' },
                { data: 'id_dossier' },
                { data: "categorie_dossier.libelle", defaultContent: "" },
                { data: "client.nom", defaultContent: ""},          
            ...
            columnDefs: [
                        ...
                        return `
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-sm-6 col-md-8" >
                                    <a  class="menu-link px-3" id="edit"   data-bs-toggle="modal" data-bs-target="#kt_modal_1" role="button"  data-bs-whatever='${recipient}' >
                ...
                
                {
                    ...
                    targets: 9, // apply to column by number of column
                    type: "date",
                    render: function ( data, type, row ) {
