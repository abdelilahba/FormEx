...
Route::group(['prefix' => '{locale}', 'where' => ['locale' => '(ar|fr)'], 'middleware' => 'web'], function () {
    ...
    Route::get('/subsciption/{random_number}', [ProfileCompletionController::class, 'subscribe']);
    Route::post('/subscribe', [ProfileCompletionController::class, 'updateSubscription'])->name('subscribe.update');
